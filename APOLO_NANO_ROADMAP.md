...
| A | M2 | 2.2 Run v1 | 🔨 **em treino (2026-07-09)** — `mini` 3,39M, 5.000 passos (~11,5M tokens ≈ 50 épocas), threads BLAS limitadas a 4 (máquina usável com o app no ar), checkpoints a cada 250 passos em `data/nanollm/ckpt_v1`, resumível. Ao terminar: rodar `python -m src.nanollm.eval --ckpt data/nanollm/ckpt_v1` e comparar com a baseline ppl 388 |
