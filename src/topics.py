...
SECTOR_KEYWORDS: dict[str, list[str]] = {
    ...
    "devops_cloud": ["kubernetes", "docker", "terraform", "aws", "gcp", "azure", "cloud", "ci/cd", "github actions", "deployment", "helm", "serverless", "lambda", "ansible", "argocd", "opentelemetry", "prometheus", "observability", "tracing", "grafana"],
    "databases": ["postgres", "sql", "redis", "mongodb", "database", "index", "sqlalchemy", "clickhouse", "timescale", "elasticsearch", "pgvector", "query optimization"],
