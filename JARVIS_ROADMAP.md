...
|-----------|-----|-------|--------|
| Q1 | M1 | Modularizar app.py | 🔨 em andamento — 15 routers (+`coder_write`: 6 rotas) + `src/coder_state.py` (baseline cache + gpu_priority compartilhados) = 77 rotas fora. app.py 3.213→2.186 (–32%) |
