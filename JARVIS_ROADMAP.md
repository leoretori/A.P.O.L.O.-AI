...
|-----------|-----|-------|--------|
| Q1 | M1 | Modularizar app.py | 🔨 em andamento — extraídos `routers/{assets,learning,sessions,profile}.py` (26 rotas); `src/runtime.py` (estado compartilhado). app.py 3.213→2.957 |
