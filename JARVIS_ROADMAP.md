...
|-----------|-----|-------|--------|
| Q1 | M1 | Modularizar app.py | 🔨 em andamento — extraídos `routers/{assets,learning,sessions}.py` (23 rotas); `src/runtime.py` (estado compartilhado, inclui dicts de sessão por referência). app.py 3.213→2.982 |
