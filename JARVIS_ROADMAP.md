...
|-----------|-----|-------|--------|
| Q1 | M1 | Modularizar app.py | 🔨 em andamento — 7 routers (`assets,learning,sessions,profile,schedules,notifications,knowledge`) = 39 rotas fora; `src/runtime.py` (estado compartilhado). app.py 3.213→2.774 |
