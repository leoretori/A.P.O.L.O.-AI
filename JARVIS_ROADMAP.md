...
|-----------|-----|-------|--------|
| Q1 | M1 | Modularizar app.py | 🔨 quase — 18 routers (+`health`: boot/health) = 90 rotas fora. Restam só 6 @app (chat/research/review/coder-ReAct/agent/orchestrate). app.py 3.213→1.785 (–44%) |
